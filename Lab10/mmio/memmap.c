...
int main (int argc, char *argv[])
{
  ...
  {
    printf("Err: Can't gather file stats");
  }
  ...
  {
    printf("Err: Can't allocate the memory for the output file");
  }
  ...
  if(write(fdout, "", 1) == -1)
  {
    printf("Err: Can't write dummy byte to file");
  }
  ...
  {
    printf("Err: Can't perform mmap for source file");
  }
  ...
  {
    printf("Err: Cant't perform mmap for source file");
  }
